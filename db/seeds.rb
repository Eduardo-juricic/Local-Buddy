...
# puts"user created"
  ...
  #   { email: 'user1@brazil.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user2@brazil.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user3@brazil.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user4@brazil.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user5@brazil.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user6@brazil.com', password: 'password', password_confirmation: 'password' },


  #   { email: 'user1@portugal.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user2@portugal.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user3@portugal.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user4@portugal.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user5@portugal.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user6@portugal.com', password: 'password', password_confirmation: 'password' },


  #   { email: 'user1@france.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user2@france.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user3@france.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user4@france.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user5@france.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user6@france.com', password: 'password', password_confirmation: 'password' },


  #   { email: 'user1@spain.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user2@spain.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user3@spain.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user4@spain.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user5@spain.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user6@spain.com', password: 'password', password_confirmation: 'password' },


  #   { email: 'user1@italy.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user2@italy.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user3@italy.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user4@italy.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user5@italy.com', password: 'password', password_confirmation: 'password' },
  #   { email: 'user6@italy.com', password: 'password', password_confirmation: 'password' }
  # ];
...
#     availability: 'Available on weekends',
#     language: 'Portuguese, English',
#     image_path: Rails.root.join("app/assets/images/perfil2.png"),
#   },
#   {
#     name: 'Ana Oliveira',
#     bio: 'I am Ana, a nature and travel enthusiast. I love hiking and outdoor photography.',
...
#     availability: 'Available only at night',
#     language: 'Portuguese, English',
#     image_path: Rails.root.join("app/assets/images/perfil3.png"),
#     user_email: 'user4@portugal.com'
#   },
#   {
#     name: 'Sofia Almeida',
#     bio: 'I am Sofia, passionate about art and history. I enjoy cultural tours and exploring museums in Lisbon.',
...
#     availability: 'Available on weekends',
#     language: 'French, English',
#     image_path: Rails.root.join("app/assets/images/perfil5.png"),
#     user_email: 'user4@france.com'
#   },
#   {
#     name: 'Claire Martin',
#     bio: 'I am Claire, a lover of fashion and art. I enjoy strolling around the city and exploring local boutiques.',
...
#     availability: 'Available on Saturdays',
#     language: 'Spanish, English',
#     image_path: Rails.root.join("app/assets/images/perfil4.png"),
#     user_email: 'user4@spain.com'
#   },
#   {
#     name: 'Carlos Martínez',
#     bio: 'I am Carlos, a lover of extreme sports and outdoor life. I love surfing and exploring new beaches in Barcelona.',
...
#     availability: 'Available during the week',
#     language: 'Italian, English',
#     image_path: Rails.root.join("app/assets/images/perfil1.png"),
#     user_email: 'user5@italy.com'
#   },
#   {
#     name: 'Federica Caruso',
#     bio: 'I am Federica, a fan of fashion and gastronomy. I enjoy visiting markets and restaurants in Milan.',
...
#     availability: 'Available on weekends',
#     language: 'Italian, English',
#     user_email: 'user6@italy.com'
#   }
# ];

# users_data.each do |user_data|
#   user = User.create!(user_data.except(:profile))
# end
